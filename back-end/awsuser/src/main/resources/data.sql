...
--
--
-- insert into boards (id, title, description, content) VALUES (1, 'QnA', 'a01', 'Q&A');
-- insert into boards (id, title, description, content) VALUES (2, '리뷰게시판', 'a01', 'Review');
-- insert into boards (id, title, description, content) VALUES (3, '자유게시판', '누구나 사용 가능한 게시판', 'Free Board');
--
--
