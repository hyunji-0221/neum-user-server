...
insert into users (id, username, password, email, name, phone, job) values (1, 'neum', '1234', 'ldannel0@ovh.net', '김민준', '18-535-5338', 'VP Sales');
...
insert into boards (id, title, description) VALUES (3, '자유게시판', 'a01');
