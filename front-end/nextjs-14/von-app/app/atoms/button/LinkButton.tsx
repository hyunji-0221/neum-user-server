...
export default function LinkButton({ id, title, path }: ILinkButton) {
    return (
            <Link key={id} href={`${path}`} className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 
...
export const linkButtonTitles = [
    ...
    { id: 5, title: '게시글목록', path: `${PG.ART}/list` },
    { id: 6, title: '마이페이지', path: `${PG.USER}/detail/${1}` }//사용자 아이디 삽입.
];
